...
import eu.cdevreeze.yaidom2.node.creationdsl.CreationDslNodes.Text
 ...
 */
final case class CreationDslElemCreator(simpleScope: SimpleScope) extends ElemCreationApi {
  ...
  /**
   * Returns `CreationDslElemCreator(simpleScope.append(otherSimpleScope))`.
   */
  def append(otherSimpleScope: SimpleScope): CreationDslElemCreator = {
    CreationDslElemCreator(simpleScope.append(otherSimpleScope))
  }
