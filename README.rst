...
Yaidom2 versions can be found in the Maven central repository. Assuming version 0.9.0, yaidom2 can be added as dependency
as follows (in an SBT or Maven build):

**SBT**::

    libraryDependencies += "eu.cdevreeze.yaidom2" %%% "yaidom2" % "0.9.0"
