...
object ENames {
  ...
  val IdEName = EName.fromLocalName("id")
  val FormEName = EName.fromLocalName("form")
  val AbstractEName = EName.fromLocalName("abstract")
  val FinalEName = EName.fromLocalName("final")
  val DefaultEName = EName.fromLocalName("default")
  val FixedEName = EName.fromLocalName("fixed")
  val TypeEName = EName.fromLocalName("type")
  val NillableEName = EName.fromLocalName("nillable")
  val BlockEName = EName.fromLocalName("block")
  val UseEName = EName.fromLocalName("use")
  val SubstitutionGroupEName = EName.fromLocalName("substitutionGroup")
  val RefEName = EName.fromLocalName("ref")
  val ReferEName = EName.fromLocalName("refer")
  val SchemaLocationEName = EName.fromLocalName("schemaLocation")
  val MinOccursEName = EName.fromLocalName("minOccurs")
  val MaxOccursEName = EName.fromLocalName("maxOccurs")
  val BaseEName = EName.fromLocalName("base")
  val TargetNamespaceEName = EName.fromLocalName("targetNamespace")
  val ElementFormDefaultEName = EName.fromLocalName("elementFormDefault")
  val AttributeFormDefaultEName = EName.fromLocalName("attributeFormDefault")
  val HrefEName = EName.fromLocalName("href")
  val OrderEName = EName.fromLocalName("order")
  val NamespaceEName = EName.fromLocalName("namespace")
  val PreferredLabelEName = EName.fromLocalName("preferredLabel")
  val PriorityEName = EName.fromLocalName("priority")
  val MixedEName = EName.fromLocalName("mixed")
  val ComplementEName = EName.fromLocalName("complement")
  val CoverEName = EName.fromLocalName("cover")
  val TestEName = EName.fromLocalName("test")
  val AspectModelEName = EName.fromLocalName("aspectModel")
  val ImplicitFilteringEName = EName.fromLocalName("implicitFiltering")
  val BindAsSequenceEName = EName.fromLocalName("bindAsSequence")
  val PrecisionEName = EName.fromLocalName("precision")
  val DecimalsEName = EName.fromLocalName("decimals")
  val SourceEName = EName.fromLocalName("source")
  val ValueEName = EName.fromLocalName("value")
  val StrictEName = EName.fromLocalName("strict")
  val SelectEName = EName.fromLocalName("select")
  val AbsoluteAcceptanceRadiusEName = EName.fromLocalName("absoluteAcceptanceRadius")
  val ProportionalAcceptanceRadiusEName = EName.fromLocalName("proportionalAcceptanceRadius")
  val RequiredEName = EName.fromLocalName("required")
  val AsEName = EName.fromLocalName("as")
  val NilsEName = EName.fromLocalName("nils")
  val MatchesEName = EName.fromLocalName("matches")
  val FallbackValueEName = EName.fromLocalName("fallbackValue")
  val RoleURIEName = EName.fromLocalName("roleURI")
  val ArcroleURIEName = EName.fromLocalName("arcroleURI")
  val ParentChildOrderEName = EName.fromLocalName("parentChildOrder")
  val TagSelectorEName = EName.fromLocalName("tagSelector")
  val MergeEName = EName.fromLocalName("merge")
  val AxisEName = EName.fromLocalName("axis")
  val DimensionEName = EName.fromLocalName("dimension")
  val IncludeUnreportedValueEName = EName.fromLocalName("includeUnreportedValue")
  val SchemeEName = EName.fromLocalName("scheme")
  val TagEName = EName.fromLocalName("tag")
  val OccEName = EName.fromLocalName("occ")
  val AugmentEName = EName.fromLocalName("augment")
  val OutputEName = EName.fromLocalName("output")
  val PatternEName = EName.fromLocalName("pattern")
  val VariableEName = EName.fromLocalName("variable")
  val MatchAnyEName = EName.fromLocalName("matchAny")
  val DateEName = EName.fromLocalName("date")
  val TimeEName = EName.fromLocalName("time")
  val BoundaryEName = EName.fromLocalName("boundary")
  val LocationEName = EName.fromLocalName("location")
  val MinimumEName = EName.fromLocalName("minimum")
  val WeightEName = EName.fromLocalName("weight")
  val CyclesAllowedEName = EName.fromLocalName("cyclesAllowed")
  val StartEName = EName.fromLocalName("start")
  val EndEName = EName.fromLocalName("end")
